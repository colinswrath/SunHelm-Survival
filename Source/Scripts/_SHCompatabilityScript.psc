...
bool Function Hunterborn()
	...
	If oxheart
        If !HunterbornInstalled          
			...
			;Drink list
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x0003FD68, "Hunterborn.esp"))	;ten dragon tea
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x000402D7, "Hunterborn.esp"))	;juniper tea
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x000402DA, "Hunterborn.esp"))	;lavender tea
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x000402DC, "Hunterborn.esp"))	;mt flower tea
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x000402DE, "Hunterborn.esp"))	;moon dance tea
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x000402E0, "Hunterborn.esp"))	;nirn spring tea
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x000402E2, "Hunterborn.esp"))	;snowberry tea
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x000402E4, "Hunterborn.esp"))	;wheat boon tea
...
bool Function CACO()
	...
	If (porkJerky)
		If (!CACOInstalled)
			...
			;Water
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x005e65d3,"Complete Alchemy & Cooking Overhaul.esp")) ;Mugwort Tea
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x005e65d6,"Complete Alchemy & Cooking Overhaul.esp")) ;Lavender Honey Tea
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x006fce69,"Complete Alchemy & Cooking Overhaul.esp")) ;Carrot Juice
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x006fce6a,"Complete Alchemy & Cooking Overhaul.esp")) ;Tomato Juice
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x00701f71,"Complete Alchemy & Cooking Overhaul.esp")) ;Snowberry Juice
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x00701f72,"Complete Alchemy & Cooking Overhaul.esp")) ;Apple Juice
			_SHDrinkList.AddForm(Game.GetFormFromFile(0x00701f74,"Complete Alchemy & Cooking Overhaul.esp")) ;Jazbay Grape Juice
			...
			_SHDrinkNoBottle.AddForm(Game.GetFormFromFile(0x01CCA126,"Update.esm")) ;light broth
			_SHDrinkNoBottle.AddForm(Game.GetFormFromFile(0x01CCA127,"Update.esm")) ;brown broth
			_SHDrinkNoBottle.AddForm(Game.GetFormFromFile(0x01CCA128,"Update.esm")) ;seafood broth
